...
impl FromStr for Champion {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        Ok(match normalized.to_lowercase().as_str() {
            ...
            "brand" => Self::Brand,
            "braum" => Self::Braum,
            "caitlyn" | "cait" => Self::Caitlyn,
            "camille" | "cam" => Self::Camille,
            "cassiopeia" | "cass" => Self::Cassiopeia,
            "chogath" | "cho" => Self::ChoGath,
            "corki" => Self::Corki,
            "darius" => Self::Darius,
            "diana" => Self::Diana,
            "draven" => Self::Draven,
